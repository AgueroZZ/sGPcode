...
load("output/sensitivity_u_alpha_easy.RData")
true_f_vec <- true_f(location_of_interest)
alpha_0.05$median <- convert_prior_median(alpha_0.05$u, 0.05)
alpha_0.1$median <- convert_prior_median(alpha_0.1$u, 0.1)
alpha_0.3$median <- convert_prior_median(alpha_0.3$u, 0.3)
alpha_0.5$median <- convert_prior_median(alpha_0.5$u, 0.5)

# merge them into a dataframe with mse, coverage and median
sensitivity_df <- rbind(alpha_0.05, alpha_0.1, alpha_0.3, alpha_0.5)
sensitivity_df <- sensitivity_df %>% arrange(median)
  
pdf(file = "output/figures/sensitivity_median_easy_mse.pdf", width = 5, height = 5)
plot(sensitivity_df$median, sqrt(sensitivity_df$mse), type = "l", 
     log = "x",
     col = 1, lwd = 2, xlab = "median", 
     lty = 1, 
     ylim = c(0.05,0.2),
     ylab = "rMSE",
     cex.lab = 1.2, 
...
pdf(file = "output/figures/sensitivity_median_easy_cov.pdf", width = 5, height = 5)
plot(sensitivity_df$median, sensitivity_df$coverage, type = "l", 
     log = "x",
     ylim = c(0.2, 1),
     col = 1, lwd = 2, xlab = "median", 
     lty = 1,
...
# merge them into a dataframe with mse, coverage and median
sensitivity_df2 <- rbind(alpha_0.05, alpha_0.1, alpha_0.3, alpha_0.5)
sensitivity_df2 <- sensitivity_df2 %>% arrange(median)

pdf(file = "output/figures/sensitivity_median_hard_mse.pdf", width = 5, height = 5)
plot(sensitivity_df2$median, sqrt(sensitivity_df2$mse), type = "l", 
     log = "x",
     col = 1, lwd = 2, xlab = "median", 
     lty = 1, 
     ylim = c(0.1,1),
...
pdf(file = "output/figures/sensitivity_median_hard_cov.pdf", width = 5, height = 5)
plot(sensitivity_df2$median, sensitivity_df2$coverage, type = "l", 
     log = "x",
     ylim = c(0.2, 1),
     col = 1, lwd = 2, xlab = "median", 
     lty = 1,
...
pdf(file = "output/figures/sensitivity_median_mse.pdf", width = 5, height = 5)
# using base R
plot(sensitivity_df$median, sqrt(sensitivity_df$mse), type = "l", 
     log = "x",
     col = 1, lwd = 2, xlab = "prior median", 
     lty = 1, 
     ylim = c(0,1),
     ylab = "rMSE",
     cex.lab = 1.2, 
     ...
     font = 2, 
     cex.axis = 1.2)
lines(sensitivity_df2$median, sqrt(sensitivity_df2$mse), col = 2, lwd = 2, lty = 2)
legend("topright", title = "Setting", legend = c("Easy (A)", "Hard (B)"), col = 1:2, lty = 1:2, lwd = 2, text.font = 2, title.cex = 1.2, cex = 1.2)
dev.off()

pdf(file = "output/figures/sensitivity_median_cov.pdf", width = 5, height = 5)
plot(sensitivity_df$median, sensitivity_df$coverage, type = "l", 
     log = "x",
     ylim = c(0.2, 1),
     col = 1, lwd = 2, xlab = "prior median", 
     ...
     font = 2,       # Bold text in plot
     cex.axis = 1.2) # Adjust axis tick size
lines(sensitivity_df2$median, sensitivity_df2$coverage, col = 2, lwd = 2, lty = 2)
abline(h = 0.95, col = "purple", lty = 5)
legend("bottomright", title = "Setting", legend = c("Easy (A)", "Hard (B)"), col
= 1:2, lty = 1:2, lwd = 2, text.font = 2, title.cex = 1.2, cex = 1.2)
dev.off()
